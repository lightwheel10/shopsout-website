...
(function () {
  ...
  const translations = {
    de: {
      ...
      'footer.subtitle': 'Sparen auf Österreichs größte Plattform für Deals und Gutscheine.',
    ...
    en: {
      ...
      'footer.subtitle': "Save on Austria's largest platform for deals and vouchers.",
